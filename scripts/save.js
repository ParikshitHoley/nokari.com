...
function jobbhar(save)
{
  save.forEach((ele,ind)=>{
    ...
    img4.src="./images/list.png";
    // --------------------------------------------------------------------------------------------

    img4.onclick= function(ind)
    {
      // save.splice(ind,1)
    ...
    //    save.push(ele);
       ...
       let save=JSON.parse(localStorage.getItem("sav"));
        save.splice(ind,1)
      localStorage.setItem("sav",JSON.stringify(save));
    ...
    savekro.innerHTML="   Apply";
    save.append(img4,savekro);
    div8.append(day,save);
    div2.append(div3,div4,div5);

    div1.append(jobname,company,div2,div6,div7,div8,folder);
